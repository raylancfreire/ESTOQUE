...
$tabela = $pdo->prepare("SELECT id_item, nome_item, qtd_item, cat_item, local_item, status_item, data_item FROM itens_tb;");
$tabela->execute();
            ...
            <table class="table">
                ...
                <tbody>
                    ...
                    foreach ($rowTabela as $linha) {
                        ...
                        echo '<td><a href=edit_tabela.php?item=' . $linha['id_item'] . ' class="btn btn-warning">Editar</a></td>';
                        echo '</tr>';
                    }
                    ?>
                </tbody>
