...
<html lang="pt-br">
    ...
    <body>
        <div class="container">
            ...
            <br>
            <form action="CRUD/emprestar.php" method="post" id="formulario">
                ...
                <div class="form-group offset-md-3">
                    <div class="col-md-8">
                        ...
                        <input type="text" name="solicitador_item" id="" class="form-control" value=<?php echo $rowTable[0]['solicitador_item']?>>
                    </div>
                </div>
                <div class="form-group offset-md-3">
                    <div class="col-md-8">
                        <label for="">Contato: </label>
                        <input type="text" name="contato_solicitador_item" id="" class="form-control" maxlength="11" value=<?php echo $rowTable[0]['contato_solicitador_item']?>>
                    </div>
                </div>
                <div class="form-group offset-md-3">
                    <div class="col-md-8">
                        <label for="">Status será alterado para "EMPRESTADO": </label>
                        <input type="text" name="status_item" id="" class="form-control" value="EMPRESTADO" onkeydown="return false;">
                    </div>
                </div>
                <br>
                <div class="form-group offset-md-3">
